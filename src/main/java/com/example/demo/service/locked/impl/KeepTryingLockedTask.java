...
@Slf4j
public class KeepTryingLockedTask implements LockedTask {

	private RedisTemplate<String, Object> redisTemplate;

	public KeepTryingLockedTask(RedisTemplate<String, Object> redisTemplate) {
		this.redisTemplate = redisTemplate;
	}

	@SneakyThrows
	@Override
	@RedisLocked(storeId = "locks", keys = "distributedLockForAnnotation", lockedType = Type.KEEP_TRYING, expiration = 5000L)
